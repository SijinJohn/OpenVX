// User node of median blur used as Heart rate
#include <iostream>
#include <cmath>
#include <complex>
#include <iterator>
...
//   USER_KERNEL_FFT  - enumeration for "app.userkernels.median_blur" kernel
//
// TODO:********
//   1. Define USER_LIBRARY_EXAMPLE
//   2. Define USER_KERNEL_FFT using VX_KERNEL_BASE() macro
enum user_library_e
{
...
int main( int argc, char * argv[] )
{
    ...
    const char * video_sequence = argv[1];  //argv[1] type char** is "/home/openvx/openvx_tutorial/build-tutorial_exercises-Desktop-Debug/Heart_rate/Heart_rate"
    CGuiModule gui( video_sequence );    //video_sequnce is 0x0 ,type char *
...
//        vxChannelExtractNode( graph, yuv_image, VX_CHANNEL_Y, luma_image ),
        userfftNode(   graph, input_rgb_image, output_filtered_image, ksize )
    };
